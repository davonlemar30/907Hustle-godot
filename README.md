...
| 5. Behavioral parity harness vs the JS oracle | ✅ core — RNG primitives, the canon market walk, and the save round-trip enforced in CI (**12,467 checks** after batch 16, floor enforced at 12,457). Save-validation and screen-smoke are CI gates too as of batch 12; the smoke gate also proves each screen's script actually attached, as of batch 15 |
